...
var _shinkansenGears = require('shinkansen-gears');
...
function REDIRECT_TO_ALPHA(_ref) {
  ...
  var pathname = _shinkansenGears.Gears.path((0, _defineProperty3.default)({}, _shinkansenBoiler.Boiler.ALPHA, alpha), _shinkansenBoiler.Boiler.ALPHA_PATTERN);
...
function REDIRECT_TO_OMEGA(_ref2) {
  ...
  var pathname = _shinkansenGears.Gears.path((_Gears$path2 = {}, (0, _defineProperty3.default)(_Gears$path2, _shinkansenBoiler.Boiler.ALPHA, alpha), (0, _defineProperty3.default)(_Gears$path2, _shinkansenBoiler.Boiler.OMEGA, omega), _Gears$path2), _shinkansenBoiler.Boiler.OMEGA_PATTERN);
...
function REDIRECT_TO_EMBARK(_ref3) {
  ...
  var pathname = _shinkansenGears.Gears.path((0, _defineProperty3.default)({}, _shinkansenBoiler.Boiler.EMBARK, embark), _shinkansenBoiler.Boiler.EMBARK_PATTERN);
...
function REDIRECT_TO_DEBARK(_ref4) {
  ...
  var pathname = _shinkansenGears.Gears.path((0, _defineProperty3.default)({}, _shinkansenBoiler.Boiler.DEBARK, debark), _shinkansenBoiler.Boiler.DEBARK_PATTERN);

  if (PATHNAME !== pathname) history.push(pathname);
}

function REDIRECT(_ref5) {
  var alpha = _ref5[_shinkansenBoiler.Boiler.ALPHA],
      omega = _ref5[_shinkansenBoiler.Boiler.OMEGA],
      embark = _ref5[_shinkansenBoiler.Boiler.EMBARK],
      debark = _ref5[_shinkansenBoiler.Boiler.DEBARK],
...
function redirectFromAlpha(_ref6) {
  var redirect = _ref6[_shinkansenBoiler.Boiler.ALPHA].redirect,
...
function redirectFromOmega(_ref7) {
  var redirect = _ref7[_shinkansenBoiler.Boiler.OMEGA].redirect,
...
function redirectFromEmbark(_ref8) {
  var redirect = _ref8[_shinkansenBoiler.Boiler.EMBARK].redirect,
...
function redirectFromDebark(_ref9) {
  var redirect = _ref9[_shinkansenBoiler.Boiler.DEBARK].redirect,
      history = _ref9.history;
  // console.log('redirectFromDebark()', redirect) // eslint-disable-line
  if (redirect) REDIRECT((0, _extends3.default)({}, redirect, { history: history }));
}

function poppet(_ref10) {
  ...
  switch (type) {
    case 'OMEGA_QUERY':
      // console.log('Valves.poppet():OMEGA_QUERY', { ...rest, type }) // eslint-disable-line
      {
      ...
      break;
    case 'EMBARK_ROUTE':
      // console.log('Valves.poppet():EMBARK_ROUTE', { ...rest, type }) // eslint-disable-line
      {
      ...
      break;
    case 'DEBARK_ROUTE':
      // console.log('Valves.poppet():DEBARK_ROUTE', { ...rest, type }) // eslint-disable-line
      {
      ...
      break;
    case 'ALPHA_QUERY':
      // console.log('Valves.poppet():ALPHA_QUERY', { ...rest, type }) // eslint-disable-line
      {
