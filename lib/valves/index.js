...
function REDIRECT_TO_ALPHA(_ref) {
  ...
  var pathname = _reactGears.Gears.path((0, _defineProperty3.default)({}, _reactBoiler.Boiler.ALPHA, alpha), _reactBoiler.Boiler.ALPHA_PATTERN);
...
function REDIRECT_TO_OMEGA(_ref2) {
  ...
  var pathname = _reactGears.Gears.path((_Gears$path2 = {}, (0, _defineProperty3.default)(_Gears$path2, _reactBoiler.Boiler.ALPHA, alpha), (0, _defineProperty3.default)(_Gears$path2, _reactBoiler.Boiler.OMEGA, omega), _Gears$path2), _reactBoiler.Boiler.OMEGA_PATTERN);
...
function REDIRECT_TO_EMBARK(_ref3) {
  ...
  var pathname = _reactGears.Gears.path((0, _defineProperty3.default)({}, _reactBoiler.Boiler.EMBARK, embark), _reactBoiler.Boiler.EMBARK_PATTERN);
...
function REDIRECT_TO_DEBARK(_ref4) {
  ...
  var pathname = _reactGears.Gears.path((0, _defineProperty3.default)({}, _reactBoiler.Boiler.DEBARK, debark), _reactBoiler.Boiler.DEBARK_PATTERN);

  if (PATHNAME !== pathname) history.push(pathname);
}

function REDIRECT(_ref5) {
  var alpha = _ref5[_reactBoiler.Boiler.ALPHA],
      omega = _ref5[_reactBoiler.Boiler.OMEGA],
      embark = _ref5[_reactBoiler.Boiler.EMBARK],
      debark = _ref5[_reactBoiler.Boiler.DEBARK],
...
function redirectFromAlpha(_ref6) {
  var redirect = _ref6[_reactBoiler.Boiler.ALPHA].redirect,
...
function redirectFromOmega(_ref7) {
  var redirect = _ref7[_reactBoiler.Boiler.OMEGA].redirect,
...
function redirectFromEmbark(_ref8) {
  var redirect = _ref8[_reactBoiler.Boiler.EMBARK].redirect,
...
function redirectFromDebark(_ref9) {
  var redirect = _ref9[_reactBoiler.Boiler.DEBARK].redirect,
