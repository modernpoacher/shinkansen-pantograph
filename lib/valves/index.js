...
var _locomotiveGears = require('locomotive-gears');
...
function REDIRECT_TO_ALPHA(_ref) {
  ...
  var pathname = _locomotiveGears.Gears.path((0, _defineProperty3.default)({}, _locomotiveBoiler.Boiler.ALPHA, alpha), _locomotiveBoiler.Boiler.ALPHA_PATTERN);
...
function REDIRECT_TO_OMEGA(_ref2) {
  ...
  var pathname = _locomotiveGears.Gears.path((_Gears$path2 = {}, (0, _defineProperty3.default)(_Gears$path2, _locomotiveBoiler.Boiler.ALPHA, alpha), (0, _defineProperty3.default)(_Gears$path2, _locomotiveBoiler.Boiler.OMEGA, omega), _Gears$path2), _locomotiveBoiler.Boiler.OMEGA_PATTERN);
...
function REDIRECT_TO_EMBARK(_ref3) {
  ...
  var pathname = _locomotiveGears.Gears.path((0, _defineProperty3.default)({}, _locomotiveBoiler.Boiler.EMBARK, embark), _locomotiveBoiler.Boiler.EMBARK_PATTERN);
...
function REDIRECT_TO_DEBARK(_ref4) {
  ...
  var pathname = _locomotiveGears.Gears.path((0, _defineProperty3.default)({}, _locomotiveBoiler.Boiler.DEBARK, debark), _locomotiveBoiler.Boiler.DEBARK_PATTERN);

  if (PATHNAME !== pathname) history.push(pathname);
}

function REDIRECT(_ref5) {
  var alpha = _ref5[_locomotiveBoiler.Boiler.ALPHA],
      omega = _ref5[_locomotiveBoiler.Boiler.OMEGA],
      embark = _ref5[_locomotiveBoiler.Boiler.EMBARK],
      debark = _ref5[_locomotiveBoiler.Boiler.DEBARK],
...
function redirectFromAlpha(_ref6) {
  var redirect = _ref6[_locomotiveBoiler.Boiler.ALPHA].redirect,
...
function redirectFromOmega(_ref7) {
  var redirect = _ref7[_locomotiveBoiler.Boiler.OMEGA].redirect,
...
function redirectFromEmbark(_ref8) {
  var redirect = _ref8[_locomotiveBoiler.Boiler.EMBARK].redirect,
...
function redirectFromDebark(_ref9) {
  var redirect = _ref9[_locomotiveBoiler.Boiler.DEBARK].redirect,
