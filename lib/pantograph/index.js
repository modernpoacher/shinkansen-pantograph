...
function graphite(_ref10) {
  ...
  var type = _ref10$action.type,
      action = _objectWithoutProperties(_ref10$action, ['type']),
  ...
  switch (type) {
    case 'OMEGA_QUERY':
      // console.log('Pantograph.graphite():OMEGA_QUERY', { ...action, type }) // eslint-disable-line
      {
      ...
      break;
    case 'EMBARK_ROUTE':
      // console.log('Pantograph.graphite():EMBARK_ROUTE', { ...action, type }) // eslint-disable-line
      {
      ...
      break;
    case 'DEBARK_ROUTE':
      // console.log('Pantograph.graphite():DEBARK_ROUTE', { ...action, type }) // eslint-disable-line
      {
      ...
      break;
    case 'ALPHA_QUERY':
      // console.log('Pantograph.graphite():ALPHA_QUERY', { ...action, type }) // eslint-disable-line
      {
