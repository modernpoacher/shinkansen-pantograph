...
function REDIRECT_TO_ALPHA(_ref) {
  ...
  var pathname = _shinkansenRails.Rails.path((0, _defineProperty3.default)({}, _shinkansenBoiler.Boiler.ALPHA, alpha), _shinkansenBoiler.Boiler.ALPHA_PATTERN);
...
function REDIRECT_TO_OMEGA(_ref2) {
  ...
  var pathname = _shinkansenRails.Rails.path((_Rails$path2 = {}, (0, _defineProperty3.default)(_Rails$path2, _shinkansenBoiler.Boiler.ALPHA, alpha), (0, _defineProperty3.default)(_Rails$path2, _shinkansenBoiler.Boiler.OMEGA, omega), _Rails$path2), _shinkansenBoiler.Boiler.OMEGA_PATTERN);
...
function REDIRECT_TO_EMBARK(_ref3) {
  ...
  var pathname = _shinkansenRails.Rails.path((0, _defineProperty3.default)({}, _shinkansenBoiler.Boiler.EMBARK, embark), _shinkansenBoiler.Boiler.EMBARK_PATTERN);
...
function REDIRECT_TO_DEBARK(_ref4) {
  ...
  var pathname = _shinkansenRails.Rails.path((0, _defineProperty3.default)({}, _shinkansenBoiler.Boiler.DEBARK, debark), _shinkansenBoiler.Boiler.DEBARK_PATTERN);
